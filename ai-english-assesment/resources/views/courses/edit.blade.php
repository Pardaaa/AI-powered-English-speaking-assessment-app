                        ...
                        <form action="{{ route('courses.update', $course->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="course-name" name="name"
                                    placeholder="Example: English Communication Technique"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="course-code" name="code"
                                    placeholder="Example: IN200" value="{{ old('code', $course->code) }}" required />
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="course-semester" name="semester"
                                    placeholder="Example: Ganjil 2025/2026" value="{{ old('semester', $course->semester) }}"
                                    required />
                            </div>
                            <div class="mb-3">
                                ...
                                <textarea id="course-description" class="form-control" name="description"
                                    placeholder="Description of the course. (Optional)">{{ old('description', $course->description) }}</textarea>
                            </div>
